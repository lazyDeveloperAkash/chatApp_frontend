          ...
          <form onSubmit={submitHandler}>
            <div className="flex flex-col gap-3 md:w-[36vw]">
              ...
              <div>
                ...
                <input className='w-full h-10 rounded-lg	p-3 mt-1 border-2 focus:border-[#4acd8d] focus:outline-none' name='contact' placeholder="Enter Your Mobile Number" type="number" onChange={(e) => setContact(e.target.value)} />
              </div>
              <div>
